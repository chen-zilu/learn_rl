...
def test_agent(model_path="true_dqn_q_net_cartpole.pth"):
    ...
    net1 = Qnet(state_dim=4, hidden_dim=128, action_dim=2).to(device)
    # 加载模型权重
...
def train():
    ...
    # 保存
    torch.save(agent.q_net.state_dict(), "true_dqn_q_net_cartpole.pth")
    torch.save(agent.target_q_net.state_dict(), "true_dqn_target_q_net_cartpole.pth")


if __name__ == '__main__':
    # train()
    # test_agent("true_dqn_q_net_cartpole.pth")
    test_agent("true_dqn_target_q_net_cartpole.pth")
